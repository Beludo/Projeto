   ...
   isset($_POST["descricao"]) && !empty($_POST["descricao"])
    ...
    if(file_exists($_FILES["foto"]["tmp_name"])){
        ...
        if(
            ...
            header("Location: ad-noticias.php?erro=1");
        }
    }else{
        // usar uma foto por omissão
        $nome_foto = "sem-foto.png";
    }
    $noticia = new noticia(0, $_POST["nome"], $_POST["descricao"], $nome_foto, true);
    $gere_noticias->adicionaNoticia($noticia);
	$gere_log->adicionarEntradaLog($_SESSION["iduser"], 'Adicionada a noticia "' . $_POST["nome"] . '"');
		  ...
		  <div class="row">
			<div class="col-xs-12">
			  ...
			  <div class="box box-primary">
				...
				<!-- form start -->
				<form role="form" method="post" action="ad-noticias.php" enctype="multipart/form-data">
				  <div class="box-body">
					<div class="form-group">
					  <label>Titulo</label>
					  <input type="text" class="form-control" name ="nome" placeholder="Insira o titulo"/>
					</div>
					<div class="form-group">
                      <label>Noticia</label>
                      <textarea class="form-control" rows="3"  name ="descricao" placeholder="Insira a noticia aqui"></textarea>
                    </div>
					<div class="form-group">
