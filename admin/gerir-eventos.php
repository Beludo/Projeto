...
<html>
  <head>
	<meta charset="UTF-8">
	<title>Admin | Gerir Eventos</title>
	  ...
	  <div class="content-wrapper">
		...
		<section class="content-header">
		  ...
		  <ol class="breadcrumb">
			...
			<li class="active"><a href="#">Gerir Eventos</a></li>
		  </ol>
		</section>
				  ...
				  <table id="example1" class="table table-bordered table-striped">
					<thead>
					 ...
					 <?php
                      ...
                      ?>
					  <tr>
						<td><?php echo $eventos[$i]->getId(); ?></td>
						<td><?php echo $eventos[$i]->getNome(); ?></td>
						<td><?php echo $eventos[$i]->getDescricao(); ?></td>
						<td><img src="img-eventos/<?php echo $eventos[$i]->getFoto()?>" alt="imagem do evento"></td>
						<?php
							if($eventos[$i]->getAtivo() == 0) {
							
							?>
							<td><span class="label label-danger">Desativo</span></td>
							<?php
							} elseif($eventos[$i]->getAtivo() == 1) {
							?>
