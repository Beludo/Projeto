	...
	<div class="container theme-showcase" role="main">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                Travessa Dona Eulália Tavares Ferreira <br>
                </p>
                <p>
                    6290-335 Gouveia<br>Portugal<br>
                </p>
                
                <p><i class="fa fa-phone"></i> 
                    Telefone: (+351) 238491018</p>
                <p><i class="fa fa-envelope-o"></i> 
                     Email: <a href="mailto:geral@esgouveia.pt">geral@esgouveia.pt</a>
                </p>
            </div>
        </div>
        <!-- /.row -->
